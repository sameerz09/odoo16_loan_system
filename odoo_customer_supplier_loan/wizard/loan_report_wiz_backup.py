...
#            'datas': data,
#        }
        return self.env['report'].get_action(self, 'odoo_customer_supplier_loan.loan_report_from_wiz', data)#self.pool['report'].get_action(self._cr, self._uid, [], 'ng_loan_payroll.loan_report_from_wiz', data=data)
