...
class BorrowerXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, partners):
      ...
      #  sheet.set_column(0, 86, 25)
        sheet.merge_range('R1:AG1', 'تقرير المقترضين', cell_format)
        ...
        sheet.write(row, col + 21, 'اصل القرض', cell_format)
        sheet.write(row, col + 22, 'عدد الاقساط', cell_format)
        ...
        sheet.write(row, col + 32, 'اسم المستفيد', cell_format)
        ...
        for loaner in loaners:
          ...
          #  print(guarantor_id.id)
           ...
           # month = datetime.datetime.strptime(str(loaner.date_disb), '%Y-%m-%d').date()
            ...
            sheet.write(row, col + 32, loaner.partner_id.name, cell_format2)
