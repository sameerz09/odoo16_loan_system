...
#                  'website_portal',
    ...
    'live_test_url' : 'https://youtu.be/UwbvANL01F8',
    'description': ''' 
...
#         'loan_details_report_view.xml',  #dd
        ...
        'report/loan_monetary/report_monetary_template.xml',
        'views/my_loan.xml',
     ##'views/account_views.xml',
        'views/disburse.xml',
        'views/loans.xml',
        'report/loan_monetary/report_recipient_template.xml',
        'report/loan_monetary/report_disburse_template.xml'
