...
class LoanPaymentDetail(models.Model):
    ...
    def button_pay(self):
        ...
        ids = self.env['partner.loan.installment.details'].search([("loan_id", "=", self.pay_id.id), ("state", "=", 'unpaid')])
        #    print (ids.loan_id)
        # for i in pay_id:
        # print (i.loan_id.id)
        ...
        for id in ids:
            ...
            if loan_id.state == 'disburse' or loan_id.state == '1disburse' or loan_id.state == '2disburse':
                if id.principal_amt > 0:
                    ...
                    if access_payment > 0  and access_payment > id.remains and new_paym == 0 and id.install_no != loan_id.dgrace:
                     ...
                     #   id.total = id.tot_due
                        ...
                        if id.state == 'paid':
                          id.payment_date = self.payment_date
                        else:
                            id.payment_date = ''
                        ...
                        print(new_paym)
                    elif access_payment > 0  and access_payment >= id.remains and new_paym == 0 and id.install_no == loan_id.dgrace:
