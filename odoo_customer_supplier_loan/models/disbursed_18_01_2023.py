    ...
    def button_pay(self):
        ...
        for id in loan_ids:
            if id.state == 'approved' or id.state == '1disburse' or id.state == '2disburse':
               # if self.pay_amt <= id.disburse_remains:
                   if id.principal_amount > 0 and id.disburse_remains == 0 and id.disburse_times == 0:
                   ...
                   elif id.principal_amount > 0 and id.disburse_remains != 0 and id.disburse_times == 1:
                 ...
                 raise Warning(
                      _('The Loan statment is not in approve state'))
