...
#         if not loan_id:
#             return res
#         prepayment_obj = self.env['partner.loan.details']
#         if loan_id:
...
#                 'account_prepayment_id': prepayment.partner_loan_account.id,
#             })
#         return res
...
#             journal_id = line.write_journal_id.id
#             address_id = line.loan_id.partner_id.address_home_id or False
