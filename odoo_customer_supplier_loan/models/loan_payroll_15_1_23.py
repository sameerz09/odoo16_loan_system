...
#                msg += 'Interest Rate\n '
            ...
            fac_seq_no = self.env['ir.sequence'].next_by_code('partner.loan.fac')
...
#                if loan.int_payable:
    ...
    def _interest_journal(self, loan, move_inrest, vals, partner_id, move_pool):
     ...
     #   debit_account_id = loan.interest_receivable_account_id.id or False
        ...
        if not loan.date_disb:
            vals.update(state='disburse', interest_loan_journal=interest_loan_journal_id.id, date_disb_grace=date_disb_grace)
        else:
