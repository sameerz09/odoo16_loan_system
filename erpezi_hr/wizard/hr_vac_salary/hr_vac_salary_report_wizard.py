...
class HrGratuitySettlementReport(models.TransientModel):
    _name = 'report.hr.vac.salary'
    _description = 'Annual Vacation Settlement PDF'
    ...
    state = fields.Selection([
        ...
        ('approve', 'Approved'),
        ('cancel', 'Cancelled')],
        default='approve', string='Status')
    vac_salary_id = fields.Many2one('hr.vac.salary', string='Employee')
    ...
    def _build_contexts(self, data):
        ...
        if data['form']['vac_salary_id'] and data['form']['vac_salary_id'][0]:
           result['vac_salary_id'] = data['form']['vac_salary_id'][0]
    ...
    def check_report(self):
        ...
        data['form'] = self.read(['date_from', 'date_to', 'company_id', 'state', 'vac_salary_id','emp_Financial_Manager', 'emp_HR_GRO_Manager', 'emp_Chief_Accountant'])[0]
    ...
    def _print_report(self, data):
        ...
        return self.env.ref(
            'erpezi_hr.report_hr_vac_salary').report_action(
            records, data=data)
